...
Circuit Designer is a web application used for designing and simulating analog and digital circuits.  
...
- **You should not import circuits using the file menu.** All circuit construction must be done through the UI.
