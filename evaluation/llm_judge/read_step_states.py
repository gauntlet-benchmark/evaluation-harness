    ...
    if show_runs:
        ...
        for run in runs:
            ...
            print(
                ...
                f"error={run.get('error')} terminated={run.get('terminated')} "
    ...
    if args.run:
        ...
        if summary_info:
            print(
                ...
                f"error={summary_info.get('error')} "
