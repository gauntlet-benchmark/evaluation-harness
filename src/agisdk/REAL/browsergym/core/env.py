...
"""
        ...
        # setup the task
        task_goal = self.task.setup(page=self.page)
    ...
    def step(self, action: Union[dict, str]) -> tuple:
        ...
        # ask the task whether the episode is over
        reward, done = self._task_validate()
    ...
    def _task_validate(self):
        ...
        # call validate
        reward, done = self.task.validate(self.page, self.chat.messages)
